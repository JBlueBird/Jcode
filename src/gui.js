    ...
    if (costume.isTainted()) {
        this.inform(
            ...
            'The picture you wish to import has been\n' +
                ...
                'making it unusable for costumes in Jcode. \n\n' +
...
IDE_Morph.prototype.snapMenu = function () {
    ...
    menu.addItem(
        'Jcode Website',
        () => window.open('kidslearntocode.org', 'SnapWebsite')
    );
    if (world.isDevMode) {
        menu.addLine();
        menu.addItem(
...
IDE_Morph.prototype.aboutSnap = function () {
    ...
    aboutTxt = 'Jcode' + '\nEasy coding for all\n\n'
        + '\n'
        + 'contactjbluebird@icloud.com\n\n'
        + '        Jcode is developed by JBlueBird'
        + '\n'
        + 'with support from my loving family\n'
        + '\n'
        + 'The design of Jcode is influenced and inspired by Scratch, and Snap!\n'
        + 'from the Lifelong Kindergarten group at the MIT Media Lab\n\n'

        + 'for more information see https://scratch.mit.edu, and https://snap.berkeley.edu';

    noticeTxt = localize('License')
        + '\n\n'
        + 'Jcode is free software: you can redistribute it and/or modify\n'
        + 'it under the terms of the GNU Affero General Public License as\n'
        + 'published by the Free Software Foundation, either version 3 of\n'
        + 'the License, or (at your option) any later version.\n\n'
    ...
    creditsTxt = localize('Contributors')
        + '\n\nJBlueBird: Countless things, creator of Jcode\n'
		+ 'Peanut Butter Squash Homeschool: Hosting Jcode\n'
		+ 'Google Blockly: Basic Block Template\n'
		+ 'Snap!: For GUI changes, base code of the Jcode online editor\n'
		+ 'Scratch: For the idea of a block gui\n\n'
		+ 'My loving Mom, Dad, and Brother'
        ;
    ...
    dlg.inform('About the Jcode project', aboutTxt, world);
...
IDE_Morph.prototype.togglePerformerMode = function () {
    ...
    if (!this.performerMode) {
        this.setStageExtent(new Point(480, 360)); //possibibly stage size? 480
    }
    this.buildPanes();
    this.fixLayout();
    this.selectSprite(this.currentSprite);
...
IDE_Morph.prototype.userSetStageSize = function () {
    new DialogBoxMorph(
        ...
        new Point(480, 360), //used to be new Point(480, 360),
        'Stage width',
        'Stage height',
        this.world(),
        null, // pic
    ...
    if (this.isIE()) {
        ...
        txt = new TextMorph(
            'Please do not use Internet Explorer.\n' +
                'Jcode runs best in a web-standards\n' +
                'compliant browser',
            dlg.fontSize,
            dlg.fontStyle,
            true,
...
IDE_Morph.prototype.warnAboutDev = function () {
    ...
    this.inform(
        ...
        'This version of Jcode is being developed.\n' +
            ...
            'visit https://kidslearntocode.org/jcode/download\n' +
            'for the official Jcode installation.'
    ).nag = true;
};
